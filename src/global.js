...
{
    "subtitle": "ECU Remapping",
    "image": "/ecu.jpg", 
    "coverage": [
      "Increased power and torque tailored to your vehicle",
      "Improved fuel efficiency through optimization",
      "Enhanced throttle response",
      "Custom software maps",
      "Smoother power delivery"
    ]
  },
  {
    "subtitle": "Speed Limiter Removal",
    "image": "/speed.jpg",
    "coverage": [
      "Remove or adjust factory-set speed restrictions",
      "Unrestricted performance capabilities",
      "Ideal for track and off-road use",
      "Professional software adjustment",
      "Custom limit settings"
    ]
  },
  {
    "subtitle": "AdBlue, EGR & DPF Solutions",
    "image": "/adblue.png",
    "coverage": [
      "AdBlue system emulation and delete solutions",
      "Reduced maintenance costs",
      "Prevention of engine limp mode",
      "Optimized exhaust system flow",
